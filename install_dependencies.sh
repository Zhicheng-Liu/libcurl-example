...
LDFLAGS="-L$dependencies_dir_abs_path/openssl/lib -L/usr/lib/x86_64-linux-gnu" CPPFLAGS="-I$dependencies_dir_abs_path/openssl/include" LIBS="-lssl -lcrypto -ldl -lpthread" ./configure --disable-shared --enable-static --without-librtmp --without-ca-bundle --disable-ldap --without-zlib --without-libidn2 --enable-pthreads --enable-threaded-resolver --without-nss --with-ssl=$dependencies_dir_abs_path/openssl --prefix=$dependencies_dir_abs_path/curl
